"""
train_complete.py  —  Fine-tuning YOLO26-seg (xlarge) no ISIC 2018 Task 1
(Lesion Boundary Segmentation, 1 classe, ~2.594 imagens de treino, 100 de val, 1.000 de teste).

Estratégia geral:
  * Dataset pequeno + 1 classe + bordas finas  -> imgsz maior, augment moderado,
    regularização forte, otimizador estável (AdamW + AMP) e desligar mosaic no final.
  * Comentários ao lado de cada hiperparâmetro explicam o valor escolhido.
"""
...
def main():
    ...
    # OBS: 'xlarge' (>68M params) é overkill para ~2.6k imagens + 1 classe e tende a overfittar.
    ...
    results = model.train(
        ...
        cls_pw=0.0,             # pos_weight do BCE de classificação. Com 1 classe, não balanceia nada.
                                #   (O comentário antigo de "peso p/ classes raras" era equivocado.)
